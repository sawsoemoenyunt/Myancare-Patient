...
class ServiceInvoiceCell: UICollectionViewCell {
    ...
    func setupViews(){
        ...
        infoLabel.anchor(lineView4.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, topConstant: 30, leftConstant: 10, bottomConstant: 0, rightConstant: 10, widthConstant: 0, heightConstant: 0)
