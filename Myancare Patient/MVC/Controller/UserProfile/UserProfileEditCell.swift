...
//  Myancare Patient
//
//  Created by SawSMN's MacBook Pro on 4/15/19.
//  Copyright © 2019 Saw Soe Moe Nyunt. All rights reserved.
//

import UIKit

class UserProfileEditCell: UICollectionViewCell, UITextFieldDelegate {
    
    var userInfoVC:UserProfileEditVC?
...
extension UserProfileEditCell: UIPickerViewDelegate, UIPickerViewDataSource{
