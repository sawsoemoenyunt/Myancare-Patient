...
class EditReminderVC: UIViewController {
    ...
    func setupViews(){
        ...
        collectionView.register(EditReminderCell.self, forCellWithReuseIdentifier: cellID)
    }
...
extension EditReminderVC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 1
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! EditReminderCell
...
class EditReminderCell: UICollectionViewCell, UITextFieldDelegate {
    
    var reminderVC: EditReminderVC?
    ...
    @objc func showRepeatingVC(){
        reminderVC?.navigationController?.pushViewController(RepeatingVC(), animated: true)
    }
