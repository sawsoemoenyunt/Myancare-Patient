...
class AddDiseaseVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @objc func addBtnClick(){
        ...
        if yearTextField.text! != "" && newDiseaseTextField.text! != ""{
            ...
            diseaseList.insert(disease, at: 0)
            self.ehrVC?.diseasesList = self.diseaseList
    ...
    func setupViews(){
        ...
        collectionView.register(AddDiseaseCell.self, forCellWithReuseIdentifier: cellID)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! AddDiseaseCell
        if diseaseList.count > 0{
            cell.titleLabel.text = diseaseList[indexPath.row].name!
            cell.yearTextField.text = diseaseList[indexPath.row].data!
            cell.isChecked = diseaseList[indexPath.row].checked!
...
class AddDiseaseCell: UICollectionViewCell {
    ...
    @objc func checkBoxClick(){
        ...
        self.ehrVC?.diseasesList[index!].checked = isChecked
    }
    ...
    @objc func yearPickerChange(){
        ...
        formatter.dateFormat = "yyyy"
        yearTextField.text = formatter.string(from: yearPicker.date)
        self.ehrVC?.diseasesList[index!].data = yearTextField.text!
